export const config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            args: [
                '--whitelisted-ips=', //IP whitelisting is a robust security measure that allows only trusted IP addresses to access a network or system while blocking all others.
                '--disable-infobars=true', // note this does not remove "Chrome is being controlled by automated test software" notification
                '--disable-gpu', //Disables GPU hardware acceleration. If software renderer is not in place, then the GPU process won't launch (handle graphics and visual processing)
                'window-size=1920,1080',
                'test-type=browser', //Type of the current test harness ("browser" or "ui" or "gpu")
